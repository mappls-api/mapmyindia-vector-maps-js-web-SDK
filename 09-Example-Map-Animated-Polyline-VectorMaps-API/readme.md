...
# Map Animated Polyline Example

### The above sample code will illustrate the very basic functionality of how to use the map Animated polyline in the Vector Maps SDK of MapmyIndia Vector Maps. It is an HTML code of how to initialize the basic MapmyIndia Vector Maps with Animated polyline funtionality.
