...
### The above sample code will illustrate the very basic functionality of how to add multiple marker in the Vector Maps SDK of MapmyIndia Vector Maps. It is an HTML code of how to initialize the basic MapmyIndia Vector Maps with the Multi Marker funtionality.
